...
plt.title('Electra Query Type Classification using Decision Tree')
plt.savefig('Electra Query Type Classification using Decision Tree.jpg')
...
plt.title('Electra Query Type Classification using Random Forest')
plt.savefig('Electra Query Type Classification using Random Forest.jpg')
...
plt.title('Electra Query Type Classification using Naive Bayes classifier')
plt.savefig('Electra Query Type Classification using Naive Bayes classifier.jpg')
...
plt.title('Electra Query Type Classification using Logistic Regression')
plt.savefig('Electra Query Type Classification using Logistic Regression.jpg')
