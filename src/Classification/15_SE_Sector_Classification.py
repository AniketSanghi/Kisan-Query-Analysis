...
plt.tight_layout()
plt.title('SE Sector Classification using Decision Tree')
plt.savefig('SE Sector Classification using Decision Tree.jpg')
plt.show()
...
plt.tight_layout()
plt.title('SE Sector Classification using Random Forest')
plt.savefig('SE Sector Classification using Random Forest.jpg')
plt.show()
...
plt.tight_layout()
plt.title('SE Sector Classification using linear SVM')
plt.savefig('SE Sector Classification using linear SVM.jpg')
plt.show()
...
plt.tight_layout()
plt.title('SE Sector Classification using KNN classifier')
plt.savefig('SE Sector Classification using KNN classifier.jpg')
plt.show()
...
plt.tight_layout()
plt.title('SE Sector Classification using Naive Bayes classifier')
plt.savefig('SE Sector Classification using Naive Bayes classifier.jpg')
plt.show()
...
plt.tight_layout()
plt.title('SE Sector Classification using Logistic Regression')
plt.savefig('SE Sector Classification using Logistic Regression.jpg')
plt.show()
